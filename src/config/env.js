...
export const env = {
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN || 'http://localhost:5173,http://localhost:3000,https://r2f.vercel.app,https://r2-lp2wcm0tg-simhadrimalladis-projects.vercel.app,https://preproute-frontend-drab.vercel.app'
};